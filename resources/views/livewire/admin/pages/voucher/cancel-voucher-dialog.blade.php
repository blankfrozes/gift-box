...
}" @open-cancel-dialog.window="open(event.detail)" @close-cancel-dialog.window="close()" x-cloak>
                ...
                <div
                    ...
                    <form wire:submit.prevent="submit" x-show="showModal" x-transition:enter="ease-out duration-200"
                        ...
                        <div class="flex items-center justify-between pb-3">
                            <p class="text-2xl font-bold">Terminate Voucher</p>
                        ...
                        <div class="w-full mb-4">
                            Are you sure to terminate this voucher with code {{ $code }}?
                        </div>

                        <!--Footer-->
                        <div class="flex justify-end pt-2 mt-2">
                            <button type="button"
                                class="px-4 py-2 mr-2 text-indigo-500 bg-transparent rounded-lg hover:bg-gray-100 hover:text-indigo-400"
                                @click="close()">Cancel</button>
                            <button type="submit"
                                class="px-4 py-2 text-white bg-indigo-500 rounded-lg hover:bg-indigo-400 disabled:bg-gray-500"
